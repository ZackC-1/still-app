...
// Usage: node docs/release/screenshots/source/frames/render-frames-v3.mjs [frame ...]
...
for (const [i, frame] of FRAMES.entries()) {
  ...
  await page.goto(`${pathToFileURL(resolve(HERE, "frames-v3.html")).href}?frame=${frame}`);
