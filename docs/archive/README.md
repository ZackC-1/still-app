...
- Repository setup: [CONTRIBUTING.md](../../CONTRIBUTING.md)
- Architecture: [ARCHITECTURE.md](../ARCHITECTURE.md)
- Release operations: [release/README.md](../release/README.md)
- Current validation evidence: [release/VALIDATION.md](../release/VALIDATION.md)
