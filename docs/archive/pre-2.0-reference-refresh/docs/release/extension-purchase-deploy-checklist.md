> **Historical snapshot, preserved September 14, 2026.** Original path: `docs/release/extension-purchase-deploy-checklist.md` at `4877e2e`.
> This records prior design/procedures, including superseded prices and incomplete status.
> Use [current guidance](https://github.com/ZackC-1/still-app/blob/main/docs/release/extension-purchase-deploy-checklist.md) for Still 2.0.0.
...
- [ ] Deploy:
      ...
      Read the [dependency configuration note](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/counter-retention.md#edge-dependency-configuration)
...
> [`06-mobile-blocking-validation.md`](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/06-mobile-blocking-validation.md).
