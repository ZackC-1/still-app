> **Historical snapshot, preserved September 14, 2026.** Original path: `docs/release/01-apple-app-store.md` at `4877e2e`.
> This records prior design/procedures, including superseded prices and incomplete status.
> Use [current guidance](https://github.com/ZackC-1/still-app/blob/main/docs/release/01-apple-app-store.md) for Still 2.0.0.
...
**Prerequisites:** RevenueCat configured ([`04-revenuecat.md`](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/04-revenuecat.md)) so the `.p8` IAP key
...
2. [ ] Declare exactly four data types (each **Collected = Yes**, **Linked to identity = Yes**,
       **Used for tracking = No**, **Purpose = App Functionality**) — matches the shipped
       `PrivacyInfo.xcprivacy` and [`docs/app-store-submission.md`](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/app-store-submission.md) §4:
...
- [ ] **Mobile-Shorts validation passed on a physical iPhone** (iOS Safari `m.youtube.com`) —
      [`06-mobile-blocking-validation.md`](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/06-mobile-blocking-validation.md) §A. This is the free-tier
...
- [ ] A sandbox purchase of `still_sync` unlocks Pro and the RevenueCat → Supabase webhook records the
      entitlement (verify in [`04-revenuecat.md` §6](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/04-revenuecat.md)).
...
2. `[CLI]` review-signin backend live, in this exact order (details + hard gates:
   ...
   (see the [dependency configuration note](https://github.com/ZackC-1/still-app/blob/4877e2ed38b8ea81feaca7b1d4d807a0a2b4f7ef/docs/release/counter-retention.md#edge-dependency-configuration)
