> **Historical snapshot, preserved September 14, 2026.** Original path: `docs/release/06-mobile-blocking-validation.md` at `4877e2e`.
> This records prior design/procedures, including superseded prices and incomplete status.
> Use [current guidance](https://github.com/ZackC-1/still-app/blob/main/docs/release/06-mobile-blocking-validation.md) for Still 2.0.0.
