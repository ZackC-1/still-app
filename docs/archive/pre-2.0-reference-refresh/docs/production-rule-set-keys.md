> **Historical snapshot, preserved September 14, 2026.** Original path: `docs/production-rule-set-keys.md` at `4877e2e`.
> This records prior design/procedures, including superseded prices and incomplete status.
> Use [current guidance](https://github.com/ZackC-1/still-app/blob/main/docs/production-rule-set-keys.md) for Still 2.0.0.
